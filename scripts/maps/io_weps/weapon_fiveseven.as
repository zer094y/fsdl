...
class weapon_fiveseven : ScriptBasePlayerWeaponEntity
{
	...
	void PrimaryAttack()
	{
		...
		g_SoundSystem.EmitSoundDyn( self.m_pPlayer.edict(), CHAN_WEAPON, "rng/kuilu/weapons/fiveseven_fire.ogg", 0.9, ATTN_NORM, 0, PITCH_NORM );
		...
		GetDefaultShellInfo( self.m_pPlayer, vecShellVelocity, vecShellOrigin, 15, 8, -6 );
