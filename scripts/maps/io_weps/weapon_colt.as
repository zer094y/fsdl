...
class weapon_colt : ScriptBasePlayerWeaponEntity
{
	...
	void PrimaryAttack()
	{
		...
		{
			case 0: g_SoundSystem.EmitSoundDyn( self.m_pPlayer.edict(), CHAN_WEAPON, "rng/kuilu/weapons/colt_fire.ogg", 0.9, ATTN_NORM, 0, PITCH_NORM ); break;
			case 1: g_SoundSystem.EmitSoundDyn( self.m_pPlayer.edict(), CHAN_WEAPON, "rng/kuilu/weapons/colt_fire.ogg", 0.9, ATTN_NORM, 0, PITCH_NORM ); break;
		}
		...
		self.m_pPlayer.FireBullets( 1, vecSrc, vecAiming, VECTOR_CONE_1DEGREES, 8192, BULLET_PLAYER_CUSTOMDAMAGE, 2, m_iBulletDamage );
		...
		GetDefaultShellInfo( self.m_pPlayer, vecShellVelocity, vecShellOrigin, 15, 10, -6 );
