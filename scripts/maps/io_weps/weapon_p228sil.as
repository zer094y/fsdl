...
class weapon_usp : ScriptBasePlayerWeaponEntity
{
	...
	void Precache()
	{
		...
		g_Game.PrecacheGeneric( "sprites/" + "kuilu/640hud12.spr" );
		g_Game.PrecacheGeneric( "sprites/" + "kuilu/640hud13.spr" );
	...
	bool PlayEmptySound()
	{
		if( self.m_bPlayEmptySound )
		{
			...
			g_SoundSystem.EmitSoundDyn( self.m_pPlayer.edict(), CHAN_WEAPON, "weapons/dryfire1.wav", 0.9, ATTN_NORM, 0, PITCH_NORM );
		}
	...
	void PrimaryAttack()
	{
		...
		else if ( g_iCurrentMode == MODE_SILENCER )
		{
			...
			self.m_pPlayer.m_iWeaponFlash = 0;
		}
		...
		if ( g_iCurrentMode == MODE_SILENCER )
		{
			...
			{
				case 0: g_SoundSystem.EmitSoundDyn( self.m_pPlayer.edict(), CHAN_WEAPON, "rng/kuilu/weapons/p228_fire_sil.ogg", 0.9, ATTN_NORM, 0, PITCH_NORM ); break;
				case 1: g_SoundSystem.EmitSoundDyn( self.m_pPlayer.edict(), CHAN_WEAPON, "rng/kuilu/weapons/p228_fire_sil.ogg", 0.9, ATTN_NORM, 0, PITCH_NORM ); break;
			}
		}
		else if ( g_iCurrentMode == MODE_NOSILENCER )
		{
			g_SoundSystem.EmitSoundDyn( self.m_pPlayer.edict(), CHAN_WEAPON, "rng/kuilu/weapons/p228_fire.ogg", 1.0, ATTN_NORM, 0, PITCH_NORM );
		}
		...
		GetDefaultShellInfo( self.m_pPlayer, vecShellVelocity, vecShellOrigin, 16, 7, -6 );
