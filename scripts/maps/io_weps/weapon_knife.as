...
class weapon_knife : ScriptBasePlayerWeaponEntity
{
	...
	bool HeavySmack( int fFirst )
	{
		...
		if ( tr.flFraction >= 1.0 )
		{
			if( fFirst != 0 )
			{
				...
				g_SoundSystem.EmitSoundDyn( self.m_pPlayer.edict(), CHAN_WEAPON, "rng/kuilu/weapons/knife_swing.ogg", 1, ATTN_NORM, 0, 94 + Math.RandomLong( 0,0xF ) );
	...
	// end aone
					...
					{
					case 0:
						g_SoundSystem.EmitSound( self.m_pPlayer.edict(), CHAN_WEAPON, "rng/kuilu/weapons/knife_stab.ogg", 1, ATTN_NORM ); break;
					}
			...
			if( fHitWorld == true )
			{
				...
				g_SoundSystem.EmitSoundDyn( self.m_pPlayer.edict(), CHAN_WEAPON, "rng/kuilu/weapons/knife_hitwall.ogg", fvolbar, ATTN_NORM, 0, 98 + Math.RandomLong( 0, 3 ) );
			}
	...
	bool Swing( int fFirst )
	{
		...
		if ( tr.flFraction >= 1.0 )
		{
			if( fFirst != 0 )
			{
				...
				// play wiff or swish sound
				g_SoundSystem.EmitSoundDyn( self.m_pPlayer.edict(), CHAN_WEAPON, "rng/kuilu/weapons/knife_swing2.ogg", 1, ATTN_NORM, 0, 94 + Math.RandomLong( 0,0xF ) );
	...
	// end aone
					...
					{
					case 0:
						g_SoundSystem.EmitSound( self.m_pPlayer.edict(), CHAN_WEAPON, "rng/kuilu/weapons/knife_hit.ogg", 1, ATTN_NORM ); break;
					case 1:
						g_SoundSystem.EmitSound( self.m_pPlayer.edict(), CHAN_WEAPON, "rng/kuilu/weapons/knife_hit2.ogg", 1, ATTN_NORM ); break;
					}
					self.m_pPlayer.m_iWeaponVolume = 128; 
					if( !pEntity.IsAlive() )
						return true;
